<template>
  <div class="_deck-builder-section-controls">
    ...
    <button class="landButton" @click="addPlains">
      <img
          alt="Plains"
    ...
    <button class="landButton" @click="addIsland">
      <img
          alt="Island"
    ...
    <button class="landButton" @click="addSwamp">
      <img
          alt="Swamp"
    ...
    <button class="landButton" @click="addMountain">
      <img
          alt="Mountain"
    ...
    <button class="landButton" @click="addForest">
      <img
          alt="Forest"
